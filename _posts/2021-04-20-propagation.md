...
layout: post
title: 离散积分传播的几种方式
date: 2021-04-20 10:07:24.000000000 +09:00
img:  one-piece/one-piece37.jpg # Add image post (optional)
tag: [数学]
---
...
y_{0+\Delta t} = y_0 + \left( {\frac{1}{6} {k_1} + {1 \over 3}{k_2} + {1 \over 3}{k_3} + \frac{1}{6} {k_4}} \right)
$$
...
[1] openvins源码：`Propagtor.h`文件中的`predict_mean_rk4`函数。